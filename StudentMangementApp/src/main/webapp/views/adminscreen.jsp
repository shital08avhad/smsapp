...
<style type="text/css">
 .enroll{
 background-image: url("image/xyz.jpg.jpg");
 ...
 .view{
 background-image: url("image/abc.jpg.jpg");
 background-size: cover;
 background-repeat: no-repeat;
 }
</style>
...
name=" studentName"/>
 <label class="form-label" for="firstName"> studentName</label>
 </div>
 </div>
 <div class="col-md-6 mb-2">
 <div class="form-outline">
...
name="studentAge"/>
 ...
 <label class="form-label" for="phoneNumber">studentCollageName </label>
 </div>
 </div>
 </div>
 <div class="row">
